	...
	zadania: {
		...
		Potwor: function(img, x, y, w, h) {
		 ...
		 Moneta: function(img, x, y, w, h) {
			...
			this.animacja = {
				obrot: {
					klatka: [this.obraz = new Obiekty.zadania.Obraz(img, 960, 256, 16, 16) ,
						this.obraz = new Obiekty.zadania.Obraz(img, 976, 256, 16, 16) ,
						this.obraz = new Obiekty.zadania.Obraz(img, 992, 256, 16, 16) ,
						this.obraz = new Obiekty.zadania.Obraz(img, 1008, 256, 16, 16) ],
					obecnaKlatka: 0
				}
			};
			this.stan = {
